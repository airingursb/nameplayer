...
Timer1.Enabled = False
'Text6(1).Text = Val(Text6(1).Text) + 1          '计算胜场
...
Dim I
MsgBox "欢迎游戏姓名大作战 v1.3，请输入对手姓名后开始游戏~", , "温馨提示"

'Text6(0).Text = ID
Label19(0).Caption = ID
Connstring = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" & App.Path & "\Data\zc.mdb;Persist Security Info=False"
...
'Adodc1.RecordSource = "select * from 注册 where 账号 = " & Text6(0).Text
'Adodc1.Refresh
'Adodc1.Recordset.Fields("胜场") = Val(Text6(1).Text)
'Adodc1.RecordSource = "注册"
'Adodc1.Refresh
'Adodc1.Recordset.MoveFirst
'Do While (Not Adodc1.Recordset.EOF)
'If (Adodc1.Recordset.Fields("账号").Value = ID) Then
'Adodc1.Recordset.Fields("胜场").Value = Label19(1)
'Exit Do
'Else
...
'Adodc1.Recordset.Fields("胜场") = Label19(1).Caption
'Adodc1.Recordset.UpdateBatch
'Adodc1.Recordset.MoveLast
'Adodc1.Recordset.Find "账号=" & Label19(0)
'Adodc1.Recordset!胜场 = Val(Label19(1))
